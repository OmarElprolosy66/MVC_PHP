                        ...
                        <div class="list-group">
                            <a href="single"
                                ...
                                <div class="w-100 justify-content-between">
                                    <img src="<?= FRONT; ?>front/upload/blog_square_01.jpg" alt=""
                            ...
                            <a href="single"
                                class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="w-100 justify-content-between">
                                    <img src="<?= FRONT; ?>front/upload/blog_square_02.jpg" alt=""
                                        class="img-fluid float-left">
                            ...
                            <a href="single"
                                ...
                                <div class="w-100 last-item justify-content-between">
                                    <img src="<?= FRONT; ?>front/upload/blog_square_03.jpg" alt=""
                                        class="img-fluid float-left">
                    ...
                    <div class="blog-list-widget">
                        <div class="list-group">
                            <a href="single"
                                class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="w-100 justify-content-between">
                                    <img src="<?= FRONT; ?>front/upload/blog_square_04.jpg" alt=""
                                        class="img-fluid float-left">
                            ...
                            <a href="single"
                                class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="w-100 justify-content-between">
                                    <img src="<?= FRONT; ?>front/upload/blog_square_07.jpg" alt=""
                                        class="img-fluid float-left">
                            ...
                            <a href="single"
                                class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="w-100 last-item justify-content-between">
                                    <img src="<?= FRONT; ?>front/upload/blog_square_06.jpg" alt=""
                                        class="img-fluid float-left">
