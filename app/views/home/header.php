...
<!-- Site Icons -->
<link rel="shortcut icon" href="<?= FRONT; ?>front/images/favicon.ico" type="image/x-icon" />
<link rel="apple-touch-icon" href="<?= FRONT; ?>front/images/apple-touch-icon.png">
...
<!-- Bootstrap core CSS -->
<link href="<?= FRONT; ?>front/css/bootstrap.css" rel="stylesheet">

<!-- FontAwesome Icons core CSS -->
<link href="<?= FRONT; ?>front/css/font-awesome.min.css" rel="stylesheet">

<!-- Custom styles for this template -->
<link href="<?= FRONT; ?>front/style.css" rel="stylesheet">

<!-- Responsive styles for this template -->
<link href="<?= FRONT; ?>front/css/responsive.css" rel="stylesheet">

<!-- Colors for this template -->
<link href="<?= FRONT; ?>front/css/colors.css" rel="stylesheet">
                        ...
                        <ul class="navbar-nav">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Top 10+ care
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">The secret of
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Benefits of face
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Relax with the
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">2017 summer stamp
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Which color is
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Subscribe to
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">The most trends
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">I visited the
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Prepared handmade
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">I recommend you
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">One of the most
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">A collection of
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">America's and
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">The most
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Stylish cabinet
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Grilled vegetable
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">The world's
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Fried veal and
                                                                            vegetable dish</a></h4>
                                                                </div><!-- end meta -->
                                                            </div><!-- end blog-box -->
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single" title="">Tasty pasta
                            ...
                            <li class="nav-item dropdown has-submenu">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdown02">
                                    <li><a class="dropdown-item" href="single">Single Blog <span
                                                class="hidden-md-down hidden-sm-down hidden-xs-down"><i
                                                    class="fa fa-angle-right"></i></span></a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="single">Single Default</a></li>
                                    ...
                                    <li><a class="dropdown-item" href="single">Blog Category <span
                                                class="hidden-md-down hidden-sm-down hidden-xs-down"><i
                                                    class="fa fa-angle-right"></i></span></a>
                                        <ul class="dropdown-menu">
